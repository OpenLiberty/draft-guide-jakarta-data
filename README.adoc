...
For more information on Jakarta Data repositories, see the documentation here: https://openliberty.io/docs/latest/jakarta-data.html#_repositories
...
For more information see the JavaDoc section on https://jakarta.ee/specifications/data/1.0/apidocs/jakarta.data/module-summary#:~:text=Refer%20to%20the%20API%20documentation%20for%20%40Query%20for%20further%20information.-,Query%20by%20Method%20Name,-The%20Query%20by%20Method%20Name%20pattern%20translates[Query by Method Name]
...
See the Javadoc for the https://jakarta.ee/specifications/data/1.0/apidocs/jakarta.data/jakarta/data/repository/query[Query Annotation] for more information on JDQL.
