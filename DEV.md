...
2. Build the Dockerfile-guides docker container from the ol.io repo using
...
4. The website will take a few minutes to build and start. View the guide at http://localhost:4000/guides/jakarta-data 